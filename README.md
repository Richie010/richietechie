...
<img src="https://img.shields.io/badge/Robotics-Experimenting-blue?style=for-the-badge"/>

<br/><br/>

`ESP32` → `Sensors` → `Motors` → `Wi-Fi` → `Robotic Systems`
...
`🐍 Python` &nbsp; `🔗 LangChain` &nbsp; `🗃️ Vector Databases`
...
### 💡 IDEA → 🧑‍💻 CODE → 🧪 EXPERIMENT → 🔧 BUILD → 🚀 IMPROVE
